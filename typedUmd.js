    ...
    e = new /*#__PURE__*/ ((function() {
      ...
      return (n.load = function(e, n, i) {
        if (
          ...
          (e.strings = []), (e.stringsElement.style.cssText =
        ...
        for (var u in (
          ...
          e.sequence[u] = u;
        (e.arrayPos = 0), (e.stopNum = 0), (e.loop =
          e.options.loop), (e.loopCount =
          e.options.loopCount), (e.curLoop = 0), (e.shuffle =
          e.options.shuffle), (e.pause = {
          status: !1,
          typewrite: !0,
          curString: "",
          curStrPos: 0
        }), (e.typingComplete = !1), (e.autoInsertCss =
          e.options.autoInsertCss), e.autoInsertCss &&
      ...
      !0 !== this.pause.status
        ? (this.timeout = setTimeout(function() {
            ...
            if ("^" === o.charAt(0) && /^\^\d+/.test(o)) {
              var a = 1;
              (a += (o = /\d+/.exec(o)[0]).length), (i = parseInt(
                o
              )), (e.temporaryPause = !0), e.options.onTypingPaused(
                e.arrayPos,
                e
              ), (t = t.substring(0, s) + t.substring(s + a)), e.toggleBlinking(
                !0
              );
            }
            if ("`" === o.charAt(0)) {
            ...
            e.timeout = setTimeout(function() {
              e.toggleBlinking(
                !1
              ), s >= t.length ? e.doneTyping(t, s) : e.keepTyping(t, s, r), e.temporaryPause && ((e.temporaryPause = !1), e.options.onTypingResumed(e.arrayPos, e));
            }, i);
          }, i))
